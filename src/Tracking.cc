...
cv::Mat Tracking::GrabImageStereo(const cv::Mat &imRectLeft, const cv::Mat &imRectRight, const double &timestamp)
{
    ...
    cv::drawKeypoints(mImGray, KeyPointsL, mImGray, cv::Scalar(0,0,255), 1); // Scalar::all(-1)
...
bool Tracking::NeedNewKeyFrame()
{
    ...
    const bool c2 = ((mnMatchesInliers<nRefMatches*thRefRatio|| bNeedToInsertClose) && mnMatchesInliers>10);  // 15
